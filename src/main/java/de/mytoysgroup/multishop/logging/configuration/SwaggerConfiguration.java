package de.mytoysgroup.multishop.logging.configuration;
...
public class SwaggerConfiguration {
	...
	public Docket newsApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				.apis(RequestHandlerSelectors.basePackage("de.mytoysgroup.multishop.logging.controller"))
				.paths(regex(".*")).build();
	}
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				...
				.description(
						"This is a Logging Service for Multishop-platform.")
				.build();
	}
